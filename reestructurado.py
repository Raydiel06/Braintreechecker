...
def get_user_input():
    api_key = input("Ingrese su clave API de Braintree: ")
    card_number = input("Ingrese el número de la tarjeta de crédito: ")
    expiration_date = input("Ingrese la fecha de vencimiento de la tarjeta (MM/YY): ")
    cvv = input("Ingrese el código CVV de la tarjeta: ")

    return api_key, card_number, expiration_date, cvv
